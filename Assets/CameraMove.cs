...
public class CameraMove : MonoBehaviour
{
    ...
    void SetUpRotation(Vector3 centerPos)
    {
        ...
        Quaternion yRotation = Quaternion.LookRotation(new Vector3(offsetToCenter.x, offsetToCenter.y, offsetToCenter.z));

        Vector3 relativeOffset = Vector3.forward * distance + Vector3.down * height;
        cameraTransform.rotation = yRotation * Quaternion.LookRotation(relativeOffset);
        cameraTransform.transform.eulerAngles = new Vector3(transform.eulerAngles.x, transform.eulerAngles.y, transform.eulerAngles.z);
